...
var languages = ["en", "sp", "po"];
var today = new Date();

//days full name languages
var daysFullEnglish = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
var daysFullSpanish = ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"];
var daysFullPortuguese = ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"];
var daysFullStrings = [daysFullEnglish, daysFullSpanish, daysFullPortuguese];
...
var monthsPortuguese = ["Janeiro", "Fevereiro", "Março", "Abril", "Malo", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"];
var monthStrings = [monthsEnglish, monthsSpanish, monthsPortuguese];

//'Time' label languages
var timeLabelEnglish = ["Time"];
var timeLabelSpanish = ["Hora"];
var timeLabelPortuguese = ["Tempo"];
var timeLabelStrings = [timeLabelEnglish, timeLabelSpanish, timeLabelPortuguese];

//custom butons languages
var buttonsEnglish = ["Today", "Tomorrow", "Next Week", "Next Month", "None"];
var buttonsSpanish = ["Hoy", "Mañana", "Siguiente Semana", "Siguiente Mes", "Sin Fecha"];
var buttonsPortuguese = ["Hoje", "Amanhã", "Próxima Semana", "Próximo Mês", "Nenhum"];
var buttonStrings = [buttonsEnglish, buttonsSpanish, buttonsPortuguese];
...
function drawCalendarStructure(containerId)
{
	...
	calendarHTML +=		'       <ul>';
	calendarHTML +=		'       	<li><div id="todayButton">Today</div></li>';
	calendarHTML +=		'       	<li><div id="tomorrowButton">Tomorrow</div></li>';
	calendarHTML +=		'       	<li><div id="nextWeekButton">Next Week</div></li>';
	calendarHTML +=		'       	<li><div id="nextMonthButton">Next Month</div></li>';
	calendarHTML +=		'       	<li><div id="noneButton">None</div></li>';
	calendarHTML +=		'       </ul>';
	calendarHTML +=		'       <ul>';
	calendarHTML +=		'       	<li><div onkeydown="saveDueDateBtnKeyDown()" id="saveDueDateBtn">Save</div></li>';
	calendarHTML +=		'       </ul>';
	calendarHTML +=		'   </div>';
