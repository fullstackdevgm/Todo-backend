...
function getCustomButtonsHTML(elementId)
{
	...
	html +=	'    <ul>';
	html +=	'    	<li><div class="button" id="todayButton_' + elementId + '" onclick="saveDate(' + today + ')">Today</div></li>';
	html +=	'    	<li><div class="button" id="tomorrowButton_' + elementId + '" onclick="saveDate(' + tomorrow + ')">Tomorrow</div></li>';
	html +=	'    	<li><div class="button" id="nextWeekButton_' + elementId + '" onclick="saveDate(' + nextWeek + ')">Next Week</div></li>';
	html +=	'    	<li><div class="button" id="nextMonthButton_' + elementId + '" onclick="saveDate(' + nextMonth + ')">Next Month</div></li>';
	html +=	'    	<li><div class="button" id="noneButton_' + elementId + '" onclick="clearDueDateInDatePicker()">None</div></li>';
	html +=	'    </ul>';
	html +=	'</div>';
...
function displayDateInElement(elementId)
{
	...
	if (sDate.unix != 0)
	{
		displayString = displayHumanReadableDate(sDate.unix);
	}
	else
	{
		displayString = 'No Date';
	}
