...
define('TDO_SERVER_TYPE', 'plano');
	...
	define('INCOMING_MAIL_ADDR', 'plano.todo-cloud.com');

	define('SITE_BASE_URL', 'plano.todo-cloud.com');
	...
	define ('SITE_BASE_S3_URL_EMAIL', 'https://s3.amazonaws.com/todopro.com/');
	...
	define('TDO_JWT_SECRET', 'plano-7VuQxXqZruwN4eArXjq$x){7T]#NF$6bB*i9k43%2xP;');
